//
//  RegistrationController.swift.swift
//  TwitterTutorial
//
...
class RegistrationController :UIViewController{
    ...
    private lazy var passwordContainerView: UIView = {
        let image = #imageLiteral(resourceName: "ic_lock_outline_white_2x") //#imageLiteral()
    ...
    @objc func handleRegistration(){
     ...
     let credentials = AuthCredenttials(email: email, password: password, fullname: fullname, username: username, profileImage: profileImage)
